...
Route::post('/insert-invoice', [InvoiceController::class, 'store'])->name('insert.invoice');

//order
Route::get('/add-order/{id}', [ProductController::class, 'purchaseData'])->middleware(['auth'])->name('add.order');
